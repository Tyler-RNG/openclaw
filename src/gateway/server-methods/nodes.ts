...
export const nodeHandlers: GatewayRequestHandlers = {
  ...
  // (extensions/sprite-core/index.ts) — it owns avatar config and atlas
  // synthesis. When sprite-core is disabled, the method is unregistered and
  // returns "method not found" naturally.
