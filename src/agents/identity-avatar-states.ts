 ...
 */
export function avatarSourceString(
  avatar: string | AgentAvatarStatesConfig | undefined,
): string | undefined {
  return typeof avatar === "string" ? avatar : undefined;
}

/** Project an identity onto the legacy string-avatar shape most consumers expect. */
export function identityWithStringAvatar<
  T extends { avatar?: string | AgentAvatarStatesConfig },
>(identity: T): Omit<T, "avatar"> & { avatar?: string } {
